...
$start=(($page-1)*15);
$end=($page*15);
$sql="select * from filetable where type=2 order by fileid asc limit ".$start.",".$end;
//echo $sql;
$re=mysql_query($sql) or die(mysql_error());//执行sql语句
$num = mysql_num_rows($re);

echo "<font color='#CC3300'>已上传的凭证：</font></br>";
		if(!$num)  
		{  
			echo "";   
		}  
		...
		{  		
			...
			echo "第&nbsp;&nbsp;";
			echo "<a href=pz.php?page=1>";
			echo " 1 </a>&nbsp;&nbsp;&nbsp;&nbsp;";
			echo "<a href=pz.php?page=2>";
			echo " 2 </a>&nbsp;&nbsp;&nbsp;&nbsp;";
			echo "页  当前第".$page.'页';;
		echo '<center>
